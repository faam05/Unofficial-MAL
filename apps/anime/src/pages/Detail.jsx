import { Accordion, Anchor, Badge, Card, Flex, Group, List, Spoiler, Tabs, Text, Title } from '@mantine/core'
...
import Characters from '../components/layouts/Characters'
import Episodes from '../components/layouts/Episodes'
import ErrorMessage from '../components/molecules/ErrorMessage'
import InformationModal from '../components/molecules/InformationModal'
import Recommendation from '../components/layouts/Recommendation'
...
const Information = lazy(() => import('../components/layouts/Information'))
...
function Detail() {
  ...
  // get details anime
  const { data, isLoading, isError } = useFetcher(`${VITE_MAIN_SERVICE_URL}/anime/${id}/full`, ['details', id])
  useFetcher(`${VITE_MAIN_SERVICE_URL}/anime/${id}/recommendations`, ['recommendations', id])
