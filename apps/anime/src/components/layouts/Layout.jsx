...
const REDIRECT_URL = import.meta.env.VITE_STREAM_URL
          ...
          <Group h='100%'>
            <Group justify='space-between' className={`flex-1 ${mobile && 'px-2'}`}>
              ...
              <Group ml='xl' gap={0}>
                {mobile && (
                  <>
                    <Button onClick={() => setOpenedModal(true)} ml={'auto'}>
                      <IconSearch />
                    </Button>
                ...
                <Menu shadow='md' width={200} mr={!mobile && 4} onChange={setOpened}>
                  ...
                  <Menu.Dropdown>
                    ...
                    <Link to={REDIRECT_URL}>
                      <Menu.Item leftSection={<IconVideo style={{ width: rem(14), height: rem(14) }} />}>Go to Stream Page</Menu.Item>
                    </Link>
                  </Menu.Dropdown>
                </Menu>
